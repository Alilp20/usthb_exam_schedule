...
const Calender = () => {
  ...
  return (
    <section className="w-full flex flex-col lg:flex-row justify-between items-center px-6 lg:px-12 gap-10 lg:gap-0">
      ...
      <div className="w-full max-w-[400px] sm:max-w-[500px] lg:max-w-[600px] animate-fade-in-left">
        <img
          src={calender}
